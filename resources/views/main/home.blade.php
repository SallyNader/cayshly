...
@endsection
  ...
  <div class="content-text">
    ...
    <h2>شبكة كيشلى للتواصل التجاري</h2>
    <p>تعد كيشلي "شبكة للتواصل التجاري" بحيث يستطيع الفرد أن يقوم بشراء أو بيع أو التعليق أو المشاركة أو ابداء الرأي أو السؤال فيما يخص  أي منتج أو خدمة.</p>

    <h2>بيع منتجاتك من كيشلى:</h2>
    <p>يمكنك بيع اي منتج أو خدمة من خلال حسابك الخاص على شبكة كيشلي. يمكنك التسجيل وانشاء حساب مجاناً وبدون أي مقابل.</p>
    <p>وهذه الخدمة متوفرة لأي فرد أو شركة أو محل أو غير ذلك من أصحاب الأعمال. كل ما عليك القيام به هو انشاء صفحة خاصة بك مجاناً وبدون أي مقابل ثم القيام بالإعلان عن المنتجات أو الخدمات التي تريد التسويق لها مع جميع التفاصيل المتعلقة بها.</p>
    <p>كما يمكنك الاعلان عن منتجات جديدة أو مستعملة .... كل ما عليك هو تحديد ذلك في الإعلان.</p>
...
@if(isset($_GET['sub']))
  ...
  <div class="box-w">
    ...
    <div class="content-text">
      ...
      <h2>شراء المنتجات من كيشلى:</h2>
      <p>في حالة رغبتك في شراء أي منتج، كل ما عليك القيام به هو البحث عن ما تريده على شبكة كيشلي.</p>
      <p>خطوات البحث:<br>
      - تصفح جميع المنتجات<br>
      - تصفح المنتجات الفرعية</p>
      <p>سوف تجد حتما ما تبحث عنه.</p>
      <p>في حالة عدم تمكنك من العثور على المنتج الذي تبحث عنه، يرجى الضغط على "مساعدة" أو ارسال بريد الكتروني لـ: <b style="font-family:Arial;">orders@cayshly.com</b></p>
  ...
  <div class="content-text">
    ...
    <h2>المشاركة والتعليق وابداء الرأي</h2>
    <p>تستطيع القيام بالمشاركة أو التعليق أو ابداء الرأي فيما يتعلق بأي من المنتجات أو الخدمات على شبكة كيشلي.</p>
    <p>يستطيع المستخدم ان يتصفح شبكة كيشلي للحصول على المزيد من المعلومات عن المنتجات أو الخدمات التي يرغب في الحصول عليها عن طريق قراءة تعليقات المستخدمين الآخرين وآرائهم. كما يستطيع أصحاب الأعمال/مقدمي الخدمات الاستفادة من هذه الآراء لتحسين منتجاتهم أو خدماتهم.</p>
  ...
  <div class="content-text">
    ...
    <h2>أسأل قبل أن تشتري</h2>
    <p>كمستخدم، يمكنك سؤال المستخدمين الآخرين عن آرائهم في المنتجات أو الخدمات التي ترغب في الحصول عليها.</p>
  ...
  <!-- End The Categories -->
  <div class="content-text">
    <h2>أجمع نقاط وأحصل على نقود</h2>
    <p>بمجرد إنشاء حساب على شبكة كيشلي، تبدأ في جمع نقاط.</p>
    <p>يجب أن يكون لدى كل مستخدم على شبكة كيشلي حساب "أم" وأفراد آخرين يندرجون تحت حساب المستخدم ويطلق عليهم "البراعم" ، يقوم كل مستخدم ببذل قصارى جهده لزيادة عدد البراعم وكذلك ستقوم كيشلي بمساعدتك في زيادة عدد البراعم في حسابك.</p>

    <p>تتحول جميع مشترياتك ومشتريات الأفراد ضمن شبكتك إلى نقاط يتم تجميعها في محفظتك.</p>
    <p><b>مثال: </b><br>لدى حساب س شبكة تتكون من 3،000،000 مستخدم، تتحول جميع مشتريات هؤلاء المستخدمين إلى نقاط يتم تجميعها في محفظة س، ثم تتحول هذه النقاط إلى نقود فعلية يمكن لصاحب الحساب س استخدامها لشراء أي منتج/خدمة من على موقع كيشلي أو طلب استرداد هذه النقاط وتحويلها إلى نقود.</p>
    
    <p>يستطيع أي مستخدم استخدام نقاطه المُجمعة عن طريقين:<br>
    - الشراء من خلال موقع كيشلي<br>
    - استرداد النقاط وتحويلها إلى نقود شريطة أن تكون هذه النقاط مساوية ل 500 جم أو اكثر من ذلك.</p>
