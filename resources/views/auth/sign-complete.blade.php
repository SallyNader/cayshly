                ...
                <div class="w-res">
                    <div class="center">
                        <div class="box sign-up">
                            ...
                            <p><i class="fa fa-fw fa-check"></i> {{ trans('sign.Youhaveregistaredsuccessfully') }}</p>
                            <p><i class="fa fa-fw fa-send"></i> {{ trans('sign.youhave500points') }}</p>
                            <p><i class="fa fa-fw fa-send"></i> {{ trans('sign.Wehavesentyouanactivationmessage') }}</p>
